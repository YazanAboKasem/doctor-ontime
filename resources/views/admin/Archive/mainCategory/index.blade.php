                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light tabstyle--two">
                            ...
                            @forelse ($mainCategories as $item)
                                <tr>
                                    <td data-label="@lang('Icon')">@php echo @$item->id @endphp</td>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="javascript:void(0)" class="icon-btn ml-1 editBtn" data-original-title="@lang('Edit')" data-toggle="tooltip" data-url="{{ route('admin.mainCategories.update', $item->id)}}" data-icon="{{ $item->icon }}" data-name="{{ $item->name }}">
                                            <i class="la la-edit"></i>
                                        </a>

                                        <a href="javascript:void(0)" class="icon-btn {{ $item->status ? 'btn--danger' : 'btn--success' }} ml-1 statusBtn" data-original-title="@lang('Status')" data-toggle="tooltip" data-url="{{ route('admin.mainCategories.status', $item->id) }}">
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{ route('admin.mainCategories.store')}}">
                    @csrf
