                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light tabstyle--two">
                            ...
                            <tr>
                                ...
                                <th scope="col">@lang('Main Category Name')</th>
                            ...
                            @forelse ($categories as $item)
                                <tr>
                                    ...
                                    <td data-label="@lang('Icon')">@php echo @$item->mainCategory->name @endphp</td>
                ...
                <form class="form-horizontal" method="post" action="{{ route('admin.category.store')}}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="category" name="main_category_id" required="">
