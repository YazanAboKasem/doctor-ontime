            ...
            <form action="{{ route('admin.products.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <input hidden type="text" id="name" name="name" placeholder="Name" class="form-control"
                               value="{{ $product->name }}">
                        <input hidden type="text" class="form-control" placeholder="@lang('Price')"
                               name="real_price"
                               value="{{ $product->real_price }}" required>
                        <input hidden type="text" class="form-control" name="URL"
                               value="{{ $product->URL }}" placeholder="www.amazon.com/XXXXXXX" required>
                        </select>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name">@lang('Product Name')</label>
                                <input type="text" id="name" name="name" placeholder="Name" class="form-control" disabled
                                       value="{{ $product->name }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select hidden class="form-control" id="category" name="category_id" required="">
                                ...
                                <select  class="form-control" id="category" name="category_id" required="">
                                    ...
                                    <option disabled value="{{ $item->id }}" {{ $product->category_id == $item->id ? 'selected' : null }}>{{ __(@$item->name) }}</option>
                                    @empty
                                    @endforelse
                                </select>
                            </div>
...
{{--                        </div>--}}
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>@lang('exl_id')</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="@lang('Exl ID')"
                                           name="exl_id"
                                            required>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input disabled type="text" class="form-control" placeholder="@lang('Price')"
                                           name="real_price"
                                           value="{{ $product->real_price }}" required>
                                    <div class="input-group-append">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="Status" name="status_id" required="">
                                    ...
                                    <option value="{{ $item->id }}" {{ $product->status_id == $item->id ? 'selected' : null }}>{{ __(@$item->name) }}</option>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea rows="10" name="About_this_item" class="form-control nicEdit"
                                          id="nicEditor0">{{ $product->About_this_item }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row element">
                                        ...
                                        @forelse($product->images as $image)
                                            <input hidden type="text" class="form-control" name="photos[]" multiple value={{$image}} />
