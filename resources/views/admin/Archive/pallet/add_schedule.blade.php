...
@section('panel')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('admin.pallet.Scheduling.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <input  type="text" id="palletId" class="form-control timepicker"
                            value={{$palletId}}
                           autocomplete="off" name="palletId" required="">
