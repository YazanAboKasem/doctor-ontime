                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name_ar" name="name_ar" placeholder="Enter Name">
                            </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="consulting_count" name="consulting_count" placeholder="Enter Count">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="month_count" name="month_count" placeholder="Enter Count">
                            </div>
