                ...
                <form action="{{ route('admin.packages.update', $package->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input value="{{$package->name_ar}}" type="text" class="form-control" id="name_ar" name="name_ar" placeholder="Enter Name">
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input value="{{$package->name_en}}" type="text" class="form-control" id="name_en" name="name_en" placeholder="Enter Name">
                                </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input value="{{$package->title_ar}}" type="text" class="form-control" id="title_ar" name="title_ar" placeholder="Enter Title">
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input value="{{$package->title_en}}" type="text" class="form-control" id="title_en" name="title_en" placeholder="Enter Title">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Consulting Count</label>
                                    <input value="{{$package->consulting_count}}" type="number" class="form-control" id="consulting_count" name="consulting_count" placeholder="Enter Count">
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Month Count</label>
                                    <input value="{{$package->month_count}}" type="number" class="form-control" id="month_count" name="month_count" placeholder="Enter Count">
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input value="{{$package->price}}" type="number" step="0.01" class="form-control" id="price" name="price" placeholder="Enter Price">
                                </div>
